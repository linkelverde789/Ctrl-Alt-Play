...
public class RepositoryListTextWebGame {
    private Connection connection;

    public RepositoryListTextWebGame(Connection connection) {
        this.connection = connection;
    }

    public List<VideogameEntity> getVideogamesList(String texto) throws SQLException {
        ...
        String query = "SELECT videojuegos.id, videojuegos.titulo, estudios.nombre AS estudio, distribuidores.nombre AS distribuidora, " +
                ...
                "WHERE videojuegos.titulo ILIKE ? " +
